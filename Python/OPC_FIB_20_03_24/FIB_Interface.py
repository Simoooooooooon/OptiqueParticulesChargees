...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    This method initializes and starts a thread for video scanning based on the current configuration.
    ...
    This method toggles the video scanning process. If the video scanning is not in progress,
    it starts the scanning. If the video scanning is already in progress, it stops the scanning.
    ...
    This method initializes and starts the video scanning process based on the current configuration.
    ...
    This method stops the video scanning process by closing tasks, stopping the timer, and updating UI.
    ...
    def quickdisplayImage(self, np_image):
        """
